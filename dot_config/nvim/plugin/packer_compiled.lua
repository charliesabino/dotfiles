...
_G.packer_plugins = {
  ...
  ["nvim-colorizer.lua"] = {
    ...
    loaded = true,
    path = "/Users/charliesabino/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
  ...
  ["vim-surround"] = {
    loaded = true,
    path = "/Users/charliesabino/.local/share/nvim/site/pack/packer/start/vim-surround",
